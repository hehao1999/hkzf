...
export default class Map extends React.Component {
  ...
  createRect(point, name, count, id) {
    ...
    label.addEventListener('click',  e => {
      ...
      // 点击和触摸？Chrome e.domEvent.changedTouches[0] 和 FireFox e
      if(e.clientX === undefined){
        const ae = e.domEvent.changedTouches[0]
        // 获取当前被点击项
        this.map.panBy(
          window.innerWidth / 2 - ae.clientX,
          (window.innerHeight - 330) / 2 - ae.clientY
          )
      } else {
        this.map.panBy(
